...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '系統ワーキンググループ'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/enecho/shoene_shinene/shin_energy/keito_wg/index.html'
...
# -----------------------------------
# selenium関係の初期設定
s#service = ChromeService(ChromeDriverManager().install()) # ドライバを自動でインストールする
