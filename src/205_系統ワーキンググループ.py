...
# 見出し1
body = '''<h1>系統ワーキンググループ</h1>
<a href="https://www.meti.go.jp/shingikai/enecho/shoene_shinene/shin_energy/keito_wg/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/enecho/shoene_shinene/shin_energy/keito_wg/index.html'
