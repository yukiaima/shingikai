...
# グリーンイノベーション戦略推進会議の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = 'グリーンイノベーション戦略推進会議'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/energy_environment/green_innovation/index.html'
