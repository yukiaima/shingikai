...
# あるべき卸電力市場、需給調整市場及び需給運用の実現に向けた実務検討作業部会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = 'あるべき卸電力市場、需給調整市場及び需給運用の実現に向けた実務検討作業部会.html'
DIR_OUTPUT = r'../meti'
...
<html>
<head>
  <title>あるべき卸電力市場、需給調整市場及び需給運用の実現に向けた実務検討作業部会</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>あるべき卸電力市場、需給調整市場及び需給運用の実現に向けた実務検討作業部会</h1>
<a href="https://www.meti.go.jp/shingikai/energy_environment/oroshi_jukyu_kento/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/energy_environment/oroshi_jukyu_kento/index.html'
