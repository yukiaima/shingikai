...
# 送配電効率化・計画進捗確認ワーキンググループの関係資料一覧のhtml作成
...
<html>
<head>
  <title>送配電効率化・計画進捗確認ワーキンググループ</title>
  <meta charset="UTF-8">
</head>
<h1>送配電効率化・計画進捗確認ワーキンググループ</h1>
<a href="https://www.emsc.meti.go.jp/activity/index_optimize.html" target="_blank">委員会ページ</a>
<body>
{body}
</body>
</html>
...
## 開催回・資料リンク先の取得
name_url_list = ['https://www.emsc.meti.go.jp/activity/index_optimize.html']
