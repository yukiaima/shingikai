...
# 地域間連系線及び地内送電系統の利用ルール等に関する検討会の関係資料一覧のhtml作成
...
<html>
<head>
  <title>地域間連系線及び地内送電系統の利用ルール等に関する検討会</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>地域間連系線及び地内送電系統の利用ルール等に関する検討会</h1>
<a href="https://www.occto.or.jp/iinkai/chinai_rule/index.html" target="_blank">委員会ページ</a>'''

# 情報を取得する対象ページ（今年度）
name_url = 'https://www.occto.or.jp/iinkai/chinai_rule/index.html'
