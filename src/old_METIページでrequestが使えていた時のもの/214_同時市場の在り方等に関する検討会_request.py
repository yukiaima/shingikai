...
# 同時市場の在り方等に関する検討会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = '同時市場の在り方等に関する検討会.html'
DIR_OUTPUT = r'../meti'
...
# 見出し1
body = '''<h1>同時市場の在り方等に関する検討会</h1>
<a href="https://www.meti.go.jp/shingikai/energy_environment/doji_shijo_kento/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/energy_environment/doji_shijo_kento/index.html'
