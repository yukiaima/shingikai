...
# 次世代の分散型電力システムに関する検討会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = '次世代の分散型電力システムに関する検討会.html'
DIR_OUTPUT = r'../meti'
...
<html>
<head>
  <title>次世代の分散型電力システムに関する検討会</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>次世代の分散型電力システムに関する検討会</h1>
<a href="https://www.meti.go.jp/shingikai/energy_environment/jisedai_bunsan/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/energy_environment/jisedai_bunsan/index.html'
