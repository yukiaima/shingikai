...
# 博士人材の産業界への入職経路の多様化に関する勉強会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = '博士人材の産業界への入職経路の多様化に関する勉強会.html'
DIR_OUTPUT = r'../meti'
...
<html>
<head>
  <title>博士人材の産業界への入職経路の多様化に関する勉強会</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>博士人材の産業界への入職経路の多様化に関する勉強会</h1>
<a href="https://www.meti.go.jp/shingikai/economy/doctoral_talent/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/economy/doctoral_talent/index.html'
