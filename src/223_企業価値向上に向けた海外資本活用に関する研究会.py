...
# 企業価値向上に向けた海外資本活用に関する研究会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '企業価値向上に向けた海外資本活用に関する研究会'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/external_economy/improving_corporate_value/index.html'
