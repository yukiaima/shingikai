...
# GXリーグにおけるサプライチェーンでの取組のあり方に関する研究会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = 'GXリーグにおけるサプライチェーンでの取組のあり方に関する研究会'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/energy_environment/gx_league/index.html'
