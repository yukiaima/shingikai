...
# アンモニア等脱炭素燃料政策小委員会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = 'アンモニア等脱炭素燃料政策小委員会.html'
DIR_OUTPUT = r'../meti'
...
# 見出し1
body = '''<h1>アンモニア等脱炭素燃料政策小委員会</h1>
<a href="https://www.meti.go.jp/shingikai/enecho/shigen_nenryo/nenryo_seisaku/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/enecho/shigen_nenryo/nenryo_seisaku/index.html'
