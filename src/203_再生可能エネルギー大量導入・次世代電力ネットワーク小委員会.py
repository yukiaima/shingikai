...
# 再生可能エネルギー大量導入・次世代電力ネットワーク小委員会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = '再生可能エネルギー大量導入・次世代電力ネットワーク小委員会.html'
DIR_OUTPUT = r'../meti'
...
<html>
<head>
  <title>再生可能エネルギー大量導入・次世代電力ネットワーク小委員会</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>再生可能エネルギー大量導入・次世代電力ネットワーク小委員会</h1>
<a href="https://www.meti.go.jp/shingikai/enecho/denryoku_gas/saisei_kano/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/enecho/denryoku_gas/saisei_kano/index.html'
