...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '電力広域的運営推進機関検証ワーキンググループ'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/enecho/denryoku_gas/denryoku_gas/koikiteki_uneisuishin_wg/index.html'
