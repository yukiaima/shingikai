...
# 電力広域的運営推進機関検証ワーキンググループの関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = '電力広域的運営推進機関検証ワーキンググループ.html'
DIR_OUTPUT = r'../meti'
...
<html>
<head>
  <title>電力広域的運営推進機関検証ワーキンググループ</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>電力広域的運営推進機関検証ワーキンググループ</h1>
<a href="https://www.meti.go.jp/shingikai/enecho/denryoku_gas/denryoku_gas/koikiteki_uneisuishin_wg/index.html" target="_blank">委員会ページ</a>'''

## 開催回・資料リンク先の取得
name_url = 'https://www.meti.go.jp/shingikai/enecho/denryoku_gas/denryoku_gas/koikiteki_uneisuishin_wg/index.html'
