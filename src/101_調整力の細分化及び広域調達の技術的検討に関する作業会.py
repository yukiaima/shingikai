...
# 調整力の細分化及び広域調達の技術的検討に関する作業会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_HTML = '調整力の細分化及び広域調達の技術的検討に関する作業会.html'
DIR_OUTPUT = r'../occto'
...
<html>
<head>
  <title>調整力の細分化及び広域調達の技術的検討に関する作業会</title>
  <meta charset="UTF-8">
</head>
<body>
{body}
...
# 見出し1
body = '''<h1>調整力の細分化及び広域調達の技術的検討に関する作業会</h1>
<a href="https://www.occto.or.jp/iinkai/chouseiryoku/index.html#sagyoukai" target="_blank">委員会ページ</a>'''

# 情報を取得する対象ページ（今年度）
name_url = 'https://www.occto.or.jp/iinkai/chouseiryoku/index.html#sagyoukai'
...
if res.status_code == 404: # ページ接続出来なかった場合
    ...
    # 需給調整市場検討小委員会に関係する部分から探索し、今年度に該当する部分を取得
    for c in soup.find('main', {'id': 'contents'}).find('h2', {'id': 'sagyoukai'}).next_siblings:
