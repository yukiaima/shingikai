...
# 電力・ガス需給と燃料（LNG）調達に関する官民連絡会議の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '電力・ガス需給と燃料（LNG）調達に関する官民連絡会議'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/energy_environment/lng/index.html'
