...
# ガス事業環境整備ワーキンググループの関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = 'ガス事業環境整備ワーキンググループ'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/enecho/denryoku_gas/jisedai_kiban/gas_business_wg/index.html'
