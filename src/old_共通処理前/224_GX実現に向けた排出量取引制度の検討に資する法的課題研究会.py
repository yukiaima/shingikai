...
# GX実現に向けた排出量取引制度の検討に資する法的課題研究会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = 'GX実現に向けた排出量取引制度の検討に資する法的課題研究会'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/energy_environment/gx_implementation/index.html'
