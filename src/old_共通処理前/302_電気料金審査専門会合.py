...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '電気料金審査専門会合'
URL_COMMITTEE = 'https://www.egc.meti.go.jp/activity/index_electricityreview.html'
...
## 開催回・資料リンク先の取得
name_url_list = ['https://www.egc.meti.go.jp/activity/index_electricityreview.html']
