...
# 長期脱炭素電源オークションにおける他市場収益の監視の在り方に関する検討会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '長期脱炭素電源オークションにおける他市場収益の監視の在り方に関する検討会'
URL_COMMITTEE = 'https://www.egc.meti.go.jp/activity/index_decarbonization.html'
...
## 開催回・資料リンク先の取得
name_url_list = ['https://www.egc.meti.go.jp/activity/index_decarbonization.html'] 
...
for name_url in name_url_list:
    ...
    # summary
    name_summary = '長期脱炭素電源オークションにおける他市場収益の監視の在り方に関する検討会 開催一覧'
