...
# 電力システム改革の検証を踏まえた制度設計ワーキンググループの関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '電力システム改革の検証を踏まえた制度設計ワーキンググループ'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/enecho/denryoku_gas/jisedai_kiban/system_design_wg/index.html'
