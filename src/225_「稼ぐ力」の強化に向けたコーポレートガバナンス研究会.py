...
# 「稼ぐ力」の強化に向けたコーポレートガバナンス研究会の関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '「稼ぐ力」の強化に向けたコーポレートガバナンス研究会'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/economy/earning_power/index.html'
