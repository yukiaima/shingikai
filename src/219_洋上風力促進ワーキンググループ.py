...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '洋上風力促進ワーキンググループ'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/enecho/denryoku_gas/saisei_kano/yojo_furyoku/index.html'
