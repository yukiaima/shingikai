...
# 見出し1
body = '''<h1>運用容量検討会</h1>
<a href="https://www.occto.or.jp/iinkai/unyouyouryou/index.html" target="_blank">委員会ページ</a>'''

# 情報を取得する対象ページ（今年度）
name_url = 'https://www.occto.or.jp/iinkai/unyouyouryou/index.html'
