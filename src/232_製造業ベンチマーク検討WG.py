...
# 製造業ベンチマーク検討ワーキンググループの関係資料一覧のhtml作成
...
# 定数定義
# -----------------------------------
NAME_COMMITTEE = '製造業ベンチマーク検討ワーキンググループ'
URL_COMMITTEE = 'https://www.meti.go.jp/shingikai/sankoshin/sangyo_gijutsu/emissions_trading/benchmark_wg/index.html'
